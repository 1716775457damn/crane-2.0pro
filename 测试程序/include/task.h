...
// #include<web.h>    // 移除Web服务器头文件以避免循环依赖
#include <chassis.h>
...
void task01(void *pvParameters)
{
    ...
    // 设置为基本循迹模式
    tracker.setRouteMode(GrayTrackerDebug::BASIC_MODE);
